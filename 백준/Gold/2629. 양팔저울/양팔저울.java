...
(4g) 1 |1 0 0 0 0 0
     2 |1 0 0 0 1 0
=> 0-1-2와 같은 조합
=> 이미 1g을 올리지 않고 4g만 올리는 경우의 모든 탐색은 위에서 완료되었음
=> result[2][4] = true이므로 더 이상 탐색X
-------------------
0-2. 1g 추가
current = 1, 1g
        0 1 2 3 4 5
...
(4g) 1 |1 1 0 0 0 0
     2 |1 1 0 1 1 1
=> 이미 1g을 추가하면서 할 수 있는 조합은 0-2로 탐색이 완료된 상태
=> 현재 저울에 1g을 놓는 것과, 반대편 저울에 1g을 놓는 것은 방향만 다를뿐 결국 같은 조합
=> 더 진행 할 경우 시간 초과 발생, 따라서 result[current][totalWeight]로 종료 조건을 줘야 함
 */